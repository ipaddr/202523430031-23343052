    ...
    return Scaffold(
      ...
      body: StreamBuilder<DocumentSnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          Color statusBgColor = const Color(0xFF22D3EE).withOpacity(0.1);
          if (status == 'verified') {
            statusText = 'DITERIMA';
                      ...
                      Expanded(
                        ...
                        child: Container(
                          ...
                          child: ElevatedButton(
                            onPressed: () async {
                              await widget.onApprove(context, widget.stationId, widget.ownerId, stationName);
                      ...
                      Expanded(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(16),
                            border: Border.all(color: const Color(0xFF4C1D24), width: 1.0),
                          ),
                          child: ElevatedButton(
                            onPressed: () async {
                              await widget.onReject(context, widget.stationId, stationName);
                              if (context.mounted) Navigator.pop(context);
                            },
                            style: ElevatedButton.styleFrom(
                              backgroundColor: Colors.transparent,
                            ...
                            child: const Text(
                              'Tolak',
                              style: TextStyle(color: Color(0xFFEF4444), fontWeight: FontWeight.w600, fontSize: 15, letterSpacing: 0.5),
                            ),
                          ),
                        ),
                      ),
